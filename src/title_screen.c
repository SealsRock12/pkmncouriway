...
static const u32 sTitleScreenRayquazaGfx[] = INCBIN_U32("graphics/title_screen/tscouri.4bpp.lz");
static const u32 sTitleScreenRayquazaTilemap[] = INCBIN_U32("graphics/title_screen/tscouri.bin.lz");
static const u32 sTitleScreenLogoShineGfx[] = INCBIN_U32("graphics/title_screen/logo_shine.4bpp.lz");
// static const u32 sTitleScreenCloudsGfx[] = INCBIN_U32("graphics/title_screen/clouds.4bpp.lz"); // Unused because clouds unused
...
static void SpriteCB_PressStartCopyrightBanner(struct Sprite *sprite)
{
  ...
  // sprite->invisible = TRUE; // Uncomment and comment rest to remove Press Start and Copyright
}
...
void CB2_InitTitleScreen(void)
{
    ...
    case 1:
        ...
        gReservedSpritePaletteCount = 8; // Original: 9
...
static void Task_TitleScreenPhase3(u8 taskId)
{
    ...
    else
    {
        ...
        gTasks[taskId].tCounter++;
	// no need for scrolling clouds if clouds
	// don't exist.
	/*
